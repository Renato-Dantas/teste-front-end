  ...
  return (
    <section className="info-sec">
      ...
      <div className="info3">
        ...
        <h2 className="info-titles" style={{ marginTop: "24px" }}>
          SEGURANÇA
        </h2>
        <div>
      ...
      <div className="form-info">
        <h2 className="form-info-title">
          ...
          <br />{" "}
          <span className="info-subtitle">E RECEBA NOVIDADES E PROMOCÕES</span>
        </h2>
        <form method="GET" action="" className="form-area">
          <h2 className="form-title">SEU NOME</h2>
          <input className="form-input" type="text" name="name" />
          <h2 className="form-title" style={{ marginTop: "19px" }}>
            SEU E-MAIL
          </h2>
